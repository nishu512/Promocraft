...
routes.delete('/deleteHording/:hordingId', hordingController.deleteHording);
routes.put("/updateAvailabilityStatus/:id", hordingController.updateAvailabilityStatus);
